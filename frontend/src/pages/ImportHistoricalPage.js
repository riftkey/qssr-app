...
//   try {
//     const res = await fetch("https://qssr-app-production.up.railway.app/api/data-collection/preview-import", {
//       method: "POST",
...
// };
  ...
  const handleImport = async () => {
    ...
    try {
      const res = await fetch("https://qssr-app-production.up.railway.app/api/data-collection/import", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          fromYear: selectedSourceYear,
